...
void intro(){
	...
	cout<<"\n\t-          MANAGEMENT SYSTEM          -";
	cout<<"\n\t---------------------------------------\n\n";
	cout<<"\t SUBMITED TO :MR ASAMINEW G. \n*";
	cout<<endl;
	cout<< "\t\t DEVELOPED BY \n";
	cout<<"*    *********************************\n";
	cout << setw(25)<<"NAME"<<setw(16)<<"ID\n\n";
	cout << setw(25)<<"EYERUSALEM SIYUM"<<setw(16)<<"BDU1201613\n\n";
	cout << setw(25)<<"FIRAOL TOLESSA"<<setw(16)<<"BDU1201719\n\n";
	cout << setw(25)<<"MAEREGU MUSTAR"<<setw(16)<<"BDU1202249\n\n";
	cout << setw(25)<<"MESERET MENGISTU"<<setw(16)<<"BDU1102420\n\n";
	cout << setw(25)<<"SAMUEL CHERU"<<setw(16)<<"BDU1301538\n\n";
	cout << setw(25)<<"YARED ABEBE"<<setw(16)<<"BDU1203281\n\n";
	cout<<"************************************************\n";
	for (int i=0; i<3;i++){
       system("color 2a");
       system("color 3b");
